...
?>
<section class="woocommerce-customer-details mt--50">
    ...
    <section class="woocommerce-columns woocommerce-columns--2 woocommerce-columns--addresses addresses">
        <div class="woocommerce-column woocommerce-column--1 woocommerce-column--billing-address">
            ...
            <h2 class="woocommerce-column__title fs--26 mb--20"><?php esc_html_e('Billing address', 'woocommerce'); ?></h2>
        ...
        <div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address">
            <h2 class="woocommerce-column__title fs--26 mb--20"><?php esc_html_e('Shipping address', 'woocommerce'); ?></h2>
            <address>
