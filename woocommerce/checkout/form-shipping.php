...
<div class="woocommerce-shipping-fields">
    <h3 class="fs--30 text-uppercase">Shipping information</h3>
    <?php if (true === WC()->cart->needs_shipping_address()) : ?>

        <h3 id="ship-to-different-address" class="mt--50">
            <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox custom-checkbox custom-checkbox--blue">
...
<div class="woocommerce-additional-fields mt--10">
